"""
Renforce la couverture ANGLAISE du tafsir (actuellement seulement 2 sources :
en-ibn-kathir, en-maarif) pour equilibrer avec l'arabe (15+ sources) — l'app
laisse choisir la langue de reponse, donc chaque langue doit avoir un corpus
d'explication du Coran solide, pas seulement l'arabe.
Meme API/format que dl_tafsir_linguistic.py (spa5k/tafsir_api).

Cibles :
  - en-al-jalalayn        -> en-jalalayn   : version anglaise du Jalalayn (deja en AR)
  - en-tafsir-ibn-abbas   -> en-ibn-abbas  : Tanwir al-Miqbas, tafsir tres ancien (attribue a Ibn Abbas)
  - en-tazkirul-quran     -> en-tazkirul   : Maulana Wahiduddin Khan, tafsir moderne respecte
  - en-tafsir-al-mukhtasar -> en-mukhtasar : version anglaise du Mukhtasar (deja en FR)
"""
...
TARGETS = {
    "en-al-jalalayn":         "en-jalalayn",
    "en-tafsir-ibn-abbas":    "en-ibn-abbas",
    "en-tazkirul-quran":      "en-tazkirul",
    "en-tafsir-al-mukhtasar": "en-mukhtasar",
}
...
def main():
    print(f"Tafsirs anglais a telecharger: {list(TARGETS.values())}", flush=True)
    total = 0
    ...
    print("ENGLISH TAFSIR DOWNLOAD DONE", flush=True)
