"""Variante GROUPEE de build_rules_tokenizer.py (2026-07-21) : 10 classes de
regles au lieu de 17, cf. build_rules_annotated_corpus_grouped.py pour le
regroupement et sa justification. Reste identique par ailleurs.
...
vers tokenizers/tajweed_rules_grouped_bpe_v1/.
"""
import os
...
ANNOTATED = BASE / "data" / "quran_tajweed_rules" / "corpus_rules_grouped.txt"
MIXED_TRAIN = BASE / "nemo_manifests_mixed" / "train_mixed.jsonl"
OUT = BASE / "tokenizers" / "tajweed_rules_grouped_bpe_v1"
