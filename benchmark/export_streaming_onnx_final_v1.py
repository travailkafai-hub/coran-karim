"""
Variante de export_streaming_onnx.py pointee sur fastconformer-final-v1 (2026-08-01) :
meme wrapper, meme validation multi-chunks, seule la source .nemo et le dossier
de sortie changent. NE PAS modifier export_streaming_onnx.py en place -- il
reste la reference/export du modele precedent (regle projet : aucune piste
n'est eliminee).
