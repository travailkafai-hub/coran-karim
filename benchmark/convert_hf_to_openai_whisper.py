"""Convertit un checkpoint Whisper HuggingFace fine-tuné -> format OpenAI (.pt)
pour l'export sherpa-onnx. Genere les cles depuis le squelette OpenAI et
retrouve chaque tenseur HF via le mapping *forward* officiel (sans collision).
Sortie: ./medium-aishell.pt  (nom attendu par sherpa export-onnx.py --model medium-aishell)
"""
import torch, whisper
from whisper.model import Whisper, ModelDimensions
from safetensors.torch import load_file

HF = "models/whisper-medium-ft/model.safetensors"
OUT = "medium-aishell.pt"

# Dimensions Whisper medium (multilingue, 80 mels)
...
# Mapping OpenAI -> HF (officiel transformers convert_openai_to_hf.WHISPER_MAPPING)
MAP = {
...
# verif chargement strict dans le modele OpenAI
