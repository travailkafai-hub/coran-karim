"""
Telecharge des sources centrees sur le CHOIX LEXICAL precis dans le Coran
(pourquoi ce mot exact plutot qu'un synonyme, gharib al-Quran, balagha).
Meme API/format que dl_tafsir.py (spa5k/tafsir_api), sauvegarde dans data/tafsir/.

Cibles :
  - tahlil-kalimat-al-qur-an        -> ar-tahlil-kalimat   (analyse mot-a-mot du Coran)
  - al-kashshaf-al-zamakhshari      -> ar-kashshaf         (Zamakhshari, reference classique balagha)
  - ar-tafseer-tahrir-al-tanwir     -> ar-ibn-ashur         (Ibn Ashur, tafsir linguistique moderne)
  - asseraj-fi-bayan-gharib-alquran -> ar-siraj-gharib      (dictionnaire gharib al-Quran)
  - al-muyassar-fi-al-gharib        -> ar-muyassar-gharib   (dictionnaire gharib, concis)
"""
...
TARGETS = {
    "tahlil-kalimat-al-qur-an":        "ar-tahlil-kalimat",
    "al-kashshaf-al-zamakhshari":      "ar-kashshaf",
    "ar-tafseer-tahrir-al-tanwir":     "ar-ibn-ashur",
    "asseraj-fi-bayan-gharib-alquran": "ar-siraj-gharib",
    "al-muyassar-fi-al-gharib":        "ar-muyassar-gharib",
}
...
def main():
    print(f"Sources linguistiques a telecharger: {list(TARGETS.values())}", flush=True)
    total = 0
    ...
    print("LINGUISTIC TAFSIR DOWNLOAD DONE", flush=True)
